...
class testeConta(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(username='usuario1', password='teste123',
    ...
    def teste_usuario_nao_existe(self):
        self.assertRaises(ValueError, User().objects.create_user, username='', email='teste123@gmail.com',
                          password='password')
